...
export default function Home() {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white">
      <h1 className="text-5xl font-bold mb-4">Hi, I'm Gauri Sharan👋</h1>
      <p className="text-xl mb-8 text-center max-w-xl">Data Scientist | 2.5+ YOE | LLMs, GenAI, NLP | Python, SQL, AWS</p>
